  ...
  if(p=='+')
    {
      ...
      printf("The %d-th movement is from track %d to %d with total seek of: %d since circular\n ",++j,size,0,abs(0));
      printf("The %d-th movement is from track %d to %d with total seek of: %d\n",++j,0,queue[0],abs(queue[0]));
      s+=abs(queue[0]);
      for(i=1;i<z;i++)
      {
        printf("The %d-th movement is from track %d to %d with total seek of: %d\n",j+1,queue[i-1],queue[i],abs(queue[i-1]-queue[i]));
        j++;s+=abs(queue[i-1]-queue[i]);
      }
      printf("\nFinal seek amount: %d\n",s);
    }
    else
...
Enter the end of the tracks(cylinder size): 199
...
The 8-th movement is from track 199 to 0 with total seek of: 0 since circular
 The 9-th movement is from track 0 to 14 with total seek of: 14
The 10-th movement is from track 14 to 37 with total seek of: 23

Final seek amount: 183
...
The 4-th movement is from track 0 to 199 with total seek of: 0 since circular
 The 5-th movement is from track 183 to 124 with total seek of: 59
The 6-th movement is from track 124 to 122 with total seek of: 2
The 7-th movement is from track 122 to 98 with total seek of: 24
The 8-th movement is from track 98 to 67 with total seek of: 31
The 9-th movement is from track 67 to 64 with total seek of: 3

Final seek amount: 239
